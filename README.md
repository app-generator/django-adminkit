...
[Admin dashboard](https://appseed.us/admin-dashboards) generated by AppSeed in **[Django](https://appseed.us/admin-dashboards/django)** Framework. AdminKit is a professional dashboard that provides hundreds of UI components, forms, tables, charts, pages and icons. The product is built on top of `Bootstrap 5`.
